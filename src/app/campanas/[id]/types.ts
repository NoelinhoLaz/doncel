...
export type Oportunidad = {
  ...
  contabilidad_entidades: { id: string; nombre: string; tipo_entidad: string; email?: string | null; telefono?: string | null; otros_tlfs?: string[] | null; otros_emails?: string[] | null; lat?: number | null; lng?: number | null; direccion: { direccion?: string; calle?: string; cp?: string; ciudad?: string; provincia?: string } | null; agente_id?: string | null; documento?: string | null; fecha_nacimiento?: string | null; created_at?: string | null; tipo_cliente_id?: string | null; config_tipos_cliente?: { id: string; etiqueta: string } | null; crm_agentes?: { id: string; nombre: string; apellidos: string; avatar_url?: string | null } | null; crm_contactos?: { id: string; nombre: string; cargo: string | null; telefono: string | null; email: string | null; metadatos?: { estrategia?: string; horarios?: string; poder_decision?: string; movil?: string; antiguedad?: string; desde?: string; anios_experiencia?: string } | null }[] } | null;
...
export type CampanaHistorialRow = {
  ...
  crm_campanas: {
    ...
    crm_campanas_estados?: { id: string; nombre: string; orden: number; color: string; es_ganado: boolean; es_final: boolean }[];
  } | null;
  crm_campanas_estados: { id: string; nombre: string; color: string; es_ganado: boolean; es_final: boolean } | null;
  crm_agentes: { id: string; nombre: string; apellidos: string; avatar_url?: string | null } | null;
};
