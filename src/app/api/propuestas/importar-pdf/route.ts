...
import { extraerSeccionesDesdeePdf, ImportarPropuestaError } from "@/lib/propuestas/importarPdf";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const resultado = await extraerSeccionesDesdeePdf(file);
    ...
    console.error("[/api/propuestas/importar-pdf] Error inesperado:", error);
    return NextResponse.json(
