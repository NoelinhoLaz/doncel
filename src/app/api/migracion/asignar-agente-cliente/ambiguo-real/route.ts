...
// Replica el criterio "ambiguo" del script principal (route.ts): cualquier cliente
// en más de un expediente, SIN comprobar si los agentes resueltos coinciden.
// Sirve para diagnosticar por qué route.ts reporta un ambiguo que /ambiguos no ve.
export async function GET() {
  try {
    ...
    return NextResponse.json({ success: true, total: ambiguousRaw.length, ambiguous: ambiguousRaw });
  } catch (err: any) {
