                      ...
                      <tbody>
                        {procesados.map((p) => (
                          <tr key={p.movimientoId} style={{ borderTop: "1px solid #f1f5f9" }}>
                            ...
                            <td style={{ padding: "0.6rem 0.9rem", color: "#334155" }}>{p.movimientoConcepto}</td>
                            <td style={{ padding: "0.6rem 0.9rem", color: "#334155" }}>{p.proveedorNombre}</td>
                            <td style={{ padding: "0.6rem 0.9rem", color: "#334155" }}>{p.expediente}</td>
                      ...
                      <tbody>
                        {tareas.map((t) => (
                          <tr key={t.id} style={{ borderTop: "1px solid #f1f5f9" }}>
                            ...
                            <td style={{ padding: "0.6rem 0.9rem", color: "#334155" }}>{t.nombre}</td>
                            <td style={{ padding: "0.6rem 0.9rem", color: "#334155" }}>{t.expediente}</td>
                            <td style={{ padding: "0.6rem 0.9rem", color: "#334155" }}>{t.movConcepto || "—"}</td>
